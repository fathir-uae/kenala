...
<head>
    ...
    <title>Loading Card by Fathir...</title>
    <style>
        body {
            margin: 0;
            height: 100vh;
...
<body>
    <div class="container">
        ...
        <div class="subtext">Maaf kalo kamu ga suka 🙏🙏</div>
        ...
        <button class="next-btn" onclick="window.location.href='Card.html'">NEXT →</button>
    </div>
    <script>
